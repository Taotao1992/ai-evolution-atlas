(() => {
  ...
  const photoScenes = [
    ...
    { title: pair("Campus storybook", "校园故事"), src: "./assets/jamie-scenes/jamie-campus-storybook.jpg" },
    { title: pair("Cafe drink", "咖啡馆饮料"), src: "./assets/jamie-scenes/jamie-cafe-drink.jpg" },
    { title: pair("Meadow walk", "草地散步"), src: "./assets/jamie-scenes/jamie-meadow-walk.jpg" },
    { title: pair("Sunhat cafe", "遮阳帽咖啡馆"), src: "./assets/jamie-scenes/jamie-sunhat-cafe.jpg" },
    { title: pair("Orange orchard", "橙子果园"), src: "./assets/jamie-scenes/jamie-orange-orchard.jpg" },
    { title: pair("Snowflake shop walk", "雪花小店散步"), src: "./assets/jamie-scenes/jamie-snowflake-shop-walk.jpg" },
    { title: pair("Computer learning", "电脑学习"), src: "./assets/jamie-scenes/jamie-computer-learning.jpg" },
    { title: pair("Flower table", "花桌探索"), src: "./assets/jamie-scenes/jamie-flower-table.jpg" },
    { title: pair("Dance living room", "客厅跳舞"), src: "./assets/jamie-scenes/jamie-dance-living-room.jpg" },
    { title: pair("Rope playground", "绳索操场"), src: "./assets/jamie-scenes/jamie-rope-playground.jpg" },
    { title: pair("Planetarium", "天象馆"), src: "./assets/jamie-scenes/jamie-planetarium.jpg" },
    { title: pair("Castle garden", "城堡花园"), src: "./assets/jamie-scenes/jamie-castle-garden.jpg" },
    { title: pair("Underwater tunnel", "水下通道"), src: "./assets/jamie-scenes/jamie-underwater-tunnel.jpg" },
    { title: pair("Robotics classroom", "机器人教室"), src: "./assets/jamie-scenes/jamie-robotics-classroom.jpg" },
    { title: pair("Rainbow sensory room", "彩虹感统室"), src: "./assets/jamie-scenes/jamie-rainbow-sensory-room.jpg" },
    { title: pair("Fruit market", "水果市场"), src: "./assets/jamie-scenes/jamie-fruit-market.jpg" },
    { title: pair("Greenhouse seedlings", "温室幼苗"), src: "./assets/jamie-scenes/jamie-greenhouse-seedlings.jpg" },
    { title: pair("Sports field", "运动场"), src: "./assets/jamie-scenes/jamie-sports-field.jpg" },
    { title: pair("Kitchen helper", "厨房小帮手"), src: "./assets/jamie-scenes/jamie-kitchen-helper.jpg" },
    { title: pair("Train window", "火车窗边"), src: "./assets/jamie-scenes/jamie-train-window.jpg" },
    { title: pair("Airport window", "机场窗边"), src: "./assets/jamie-scenes/jamie-airport-window.jpg" },
    { title: pair("Mountain lookout", "山景观景台"), src: "./assets/jamie-scenes/jamie-mountain-lookout.jpg" },
    { title: pair("Beach kite", "海滩风筝"), src: "./assets/jamie-scenes/jamie-beach-kite.jpg" },
    { title: pair("Bookstore reading", "书店阅读"), src: "./assets/jamie-scenes/jamie-bookstore-reading.jpg" },
    { title: pair("Art museum watercolor", "艺术馆水彩"), src: "./assets/jamie-scenes/jamie-art-museum-watercolor.jpg" },
    { title: pair("Reading tent", "阅读帐篷"), src: "./assets/jamie-scenes/jamie-reading-tent.jpg" }
  ];
