...
If you need a safe example of the expected source format, use:

- `examples/team-registration-anonymized.xlsx`
- `examples/team-registration-anonymized.csv`

Those sample files keep the original layout but replace all student details with fictional placeholders.
